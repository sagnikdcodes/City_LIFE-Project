...
<div id="container">
  ...
  <div id="login_banner_panel">
    ...
    <div id="login_panel">
      <h1>&nbsp;</h1>
      <h1 align="center"><font face="Aerial">Smells yummy</font></h1>
      <h1 align="center"><font face="Aerial">Tastes delicious</font></h1>
    </div>
  </div>
<div id="menu">
    <ul>
<li class="first"><a href="002.jsp">Home</a></li>
      ...
      <li><a href="showr.jsp" class="current">Restaurants</a></li>
...
try{
	...
	PreparedStatement ps=cn.prepareStatement("select name,addr,phno,fileadd,rid from resturant");
...
<table width="70%" border="1" cellpadding="2">
  ...
  <%String newpicadd= picname.substring(picname.lastIndexOf('\\')+1,picname.length()); %>
    <td rowspan="4" width="40%"><img src="${pageContext.request.contextPath}/images/imageres/<%=newpicadd %>" height=200 width=350 ></td>
  ...
  <tr>
    <td><strong>Contact number: </strong><%=rs.getString(3) %></td>
  </tr>
  <tr>
    <td><a href="logcheckr?uid=<%=rs.getString(5)%>">MoreDetails</a></td>
