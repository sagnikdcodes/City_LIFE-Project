...
public class updatehotel extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			String hid=(String)sess.getAttribute("hid");
			...
			String sql="update hotel set name=?,addr=?,phno=?,fileadd=?,rate=? where hid=?";
			...
			RequestDispatcher rd=request.getRequestDispatcher("updatedroph.jsp");
