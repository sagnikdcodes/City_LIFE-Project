...
<title>Insert into restaurant</title>

</head>
<body background= "images/WDF_2325985.jpg">

<form action="insertr" name="r"  method="post" enctype="multipart/form-data" value="1">

<table border="1" align="center">

<div align="center" id="i">Insert into table</div>

<tr><td>ID: </td><td><input type="text" name="rid"></td></tr>
...
<td colspan="2" align="center"><input type="submit" value="insert" onclick="insertr"></td>
