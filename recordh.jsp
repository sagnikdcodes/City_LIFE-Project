...
%>
<table  width="400"border="1" bordercolor="black"  borderwidth="2px" cellpadding="2" align="center">
...
<% System.out.println("file address" +picname);%>
  <%String newpicadd= picname.substring(picname.lastIndexOf('\\')+1,picname.length()); %>
    ...
    <td rowspan="4" ><img src="${pageContext.request.contextPath}/images/imageh/<%=newpicadd %>" height=300 width=400 ></td>
...
<tr><td><strong>Phno :</strong></td><td><%=rs.getString(4) %></td></tr>
<tr><td><strong>Rating :</strong></td><td><%=rs.getString(6) %></td></tr>

<tr><td align="left"><strong>Description :</strong></td><td align="left"><%=rs.getString(7) %></td></tr>
