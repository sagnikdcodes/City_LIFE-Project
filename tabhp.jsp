...
<title>Insert into hospital</title>

</head>
<body background= "images/WDF_2325985.jpg">


<form action="inserthp" name="hp"  method="post" enctype="multipart/form-data" value="1">
...
<tr><td>ID: </td><td><input type="text" name="hpid"></td></tr>
