...
try{
	...
	String sql="select * from resturant where rid=?";
...
<% System.out.println("file address" +picname);%>
  <%String newpicadd= picname.substring(picname.lastIndexOf('\\')+1,picname.length()); %>
    ...
    <td rowspan="4"  ><img src="${pageContext.request.contextPath}/images/imageres/<%=newpicadd %>"height=400 width=500 ></td>
...
<tr><td><strong>Cuisine:</strong></td><td><%=rs.getString(5) %></td></tr>
<tr><td><strong>time :</strong></td><td><%=rs.getString(7) %></td></tr>
