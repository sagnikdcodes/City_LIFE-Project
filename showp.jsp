...
<div id="container">
  ...
  <div id="login_banner_panel">
    ...
    <div id="login_panel">
      <h1>&nbsp;</h1>
      <h1  align="center">Beautiful one day</h1>
      <h1 align="center">Perfect the next</h1>
    </div>
  </div>
<div id="menu">
    <ul>
...
<table width="70%" border="1" cellpadding="2">
  ...
  <%String newpicadd= picname.substring(picname.lastIndexOf('\\')+1,picname.length()); %>
    <td rowspan="4" width="40%"><img src="${pageContext.request.contextPath}/images/imageptov/<%=newpicadd %>"height=200 width=350 ></td>
  ...
  <tr>
    <td><strong>Time: </strong><%=rs.getString(4) %></td>
  </tr>
  <tr>
    <td><a href="logcheck?uid=<%=rs.getString(1)%>">MoreDetails</a></td>
