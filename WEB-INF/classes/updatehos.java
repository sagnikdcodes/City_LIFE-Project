...
/**
 * Servlet implementation class updatehos
 */
@WebServlet("/updatehos")
@MultipartConfig(fileSizeThreshold=1024*1024*2,maxFileSize=1024*1024*10,maxRequestSize=1024*1024*50)
public class updatehos extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final String SAVE_DIR="imagehp";
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String hpid=(String)sess.getAttribute("hpid");
			...
			String sql="update hospital set name=?,addr=?,phno=?,specialist=?,fileadd=?where hpid=?";
			...
			RequestDispatcher rd=request.getRequestDispatcher("updatedrophp.jsp");
