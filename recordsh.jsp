...
<title>Record Shopping Mall</title>
...
try{
	...
	String sql="select * from shoppingmall where sid=?";
...
<% System.out.println("file address" +picname);%>
  <%String newpicadd= picname.substring(picname.lastIndexOf('\\')+1,picname.length()); %>
    ...
    <td rowspan="4" ><img src="${pageContext.request.contextPath}/images/imagesh/<%=newpicadd %>" height=300 width=400 ></td>
    
  </tr>
</table>
<table border="1" bordercolor="black"  borderwidth="2px" cellpadding="2" align="center">
<tr><td><strong>Full Address :</strong></td><td><%=rs.getString(3) %></td></tr>
<tr><td><strong>Contact number : </strong></td><td><%=rs.getString(4) %></td></tr>
<tr><td><strong>Time :</strong></td><td><%=rs.getString(5) %></td></tr>
<tr><td><strong>Description :</strong></td><td><%=rs.getString(8) %></td></tr>
<tr><td><strong>Stores :</strong></td><td><%=rs.getString(6) %></td></tr>
<tr><td><strong>Resturants :</strong></td><td><%=rs.getString(9) %></td></tr>
