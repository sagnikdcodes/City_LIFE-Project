...
<div id="container">
  <div id="header_panel">
    ...
    City Life<br><font size="2">#explore, visit and experience</font>
 	</div>
  ...
  <div id="login_banner_panel">
    ...
    <div id="login_panel">
      <h1>&nbsp;</h1>
      <h1 align="center"><font size="6" face="Cooper Black">Everything </font></h1>
      <h1 align="center"><font size="6" face="Cooper Black">Except</font></h1>
      <h1 align="center"><font size="6" face="Cooper Black">Excess</font></h1>
    </div>
  </div>
<div id="menu">
    <ul>
<li class="first"><a href="002.jsp">Home</a></li>
      ...
      <li><a href="showh.jsp" class="current">Hotels</a></li>
...
try{
	...
	PreparedStatement ps=cn.prepareStatement("select hid,name,addr,phno,fileadd from hotel");
...
<td rowspan="4" width="40%"><img src="${pageContext.request.contextPath}/images/imageh/<%=newpicadd %>"height=200 width=250 ></td>
<td><strong>Name:</strong> <%=rs.getString(2) %></td>
</tr>
<tr>
<td><strong>Address: </strong><%=rs.getString(3) %></td>
</tr>
<tr>
<td><strong>Contactno:</strong> <%=rs.getString(4) %></td></tr>
<tr>
<td><a href="logcheckh?uid=<%=rs.getString(1)%>">MoreDetails</a></td>
