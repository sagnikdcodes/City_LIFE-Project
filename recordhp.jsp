...
<%
try{
	String hpid=request.getParameter("uid");
...
%>
<table  border="1" bordercolor="black"  borderwidth="2px" cellpadding="2" align="center"><tr><td colspan="3" align="center"><b><%=rs.getString(2) %></b></td></tr>
<tr>
<% System.out.println("file address" +picname);%>
  <%String newpicadd= picname.substring(picname.lastIndexOf('\\')+1,picname.length()); %>
    <td rowspan="4" ><img src="${pageContext.request.contextPath}/images/imagehp/<%=newpicadd %>"  height=300 width=400 ></td>
...
<tr><td><strong>Specialist: </strong></td><td><%=rs.getString(5) %></td></tr>
<tr><td><strong>Description: </strong></td><td><%=rs.getString(7) %></td></tr>
